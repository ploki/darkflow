...
OpUnsharpMask::OpUnsharpMask(Process *parent) :
    ...
    m_radius(new OperatorParameterSlider("radius", "Radius", "Unsharp Mask Radius", Slider::Value, Slider::Logarithmic, Slider::Real, .01, 100, 1, .001, 1000, Slider::FilterPixels, this)),
